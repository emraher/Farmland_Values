...
dashboardPage(
  ...
  sidebarMenu(
    ...
    HTML('<h6><strong>Created by <a href="mailto:eremrah@ksu.edu?Subject=About%20Estimating%20Farmland%20Values%20Based%20on%20Historic%20Index%20Numbers" target="_top">Emrah Er</a></h6></strong>'),
...
br(),
HTML('<h4 align="center"><strong>Terry W. Griffin (<a href="mailto:twgriffin@ksu.edu?Subject=About%20Estimating%20Farmland%20Values%20Based%20on%20Historic%20Index%20Numbers" target="_top">twgriffin@ksu.edu</a> Kansas State University)</h4></strong>'),
HTML('<h4 align="center"><strong>Mykel R. Taylor (<a href="mailto:mtaylor@ksu.edu?Subject=About%20Estimating%20Farmland%20Values%20Based%20on%20Historic%20Index%20Numbers" target="_top">mtaylor@ksu.edu</a> Kansas State University)</h4></strong>'),
hr(),
...
h4(strong("Resources:")),
h4("USDA NASS. QuickStats. http://www.nass.usda.gov/Quick_Stats/"),
h4("USDA NASS. Land Values 2015 Summary, August 2015 ISSN: 1949-1867")
    ...
    tabItem(tabName = "CalcsubItemOne",
            fluidRow(
              box(title = "Description", status = "info", solidHeader = TRUE, height = 350,
              ...
              box(title = "Example", status = "info", solidHeader = TRUE, height = 350,
                  HTML("The farmland value for a past year can be estimated using the following formula:<br>"),
                  withMathJax("$$Farmland~Value_{Past~Year} = Farmland~Value_{Current~Year} * \\frac{Index~Value_{Past~Year}}{Index~Value_{Current~Year}}$$"),
                  HTML("<strong>Example:<br>
Current land values are $2,000 per acre. What was the approximate value of this land in 1987?</strong><br>
Using the results above, the index values for <strong>1987</strong> and <strong>2014</strong> are <strong>59.39</strong> and <strong>326.43</strong>, respectively."),
            ...
            fluidRow(
                box(title = "Enter Values", status = "warning", solidHeader = TRUE, height = 350,
                  # USER INPUTS 1
                  ...
                  numericInput("valuecurrent", label = ("Current Farmland Value"), value = 2000)
                ),
                box(title = "Results", status = "success", solidHeader = TRUE, height = 350,
                  # CALCULATIONS 1
    ...
    tabItem(tabName = "CalcsubItemTwo",
            fluidRow(
              ...
              box(title = "Example", status = "info", solidHeader = TRUE, height = 350,
                  ...
                  withMathJax("$$Farmland~Value_{Current~Year} = Farmland~Value_{Past~Year} * \\frac{Index~Value_{Current~Year}}{Index~Value_{Past~Year}}$$"),
                  HTML("<strong>Example:<br>
                      My relative paid $225 per acre for land in 1969. What is the estimated value of this land today</strong><br>
                  ...
                  withMathJax("$$Estimated~2014~Farmland~Value = 225 * \\frac{326.43}2014{59.39}$$"),
            ...
            fluidRow(
              box(title = "Enter Values", status = "warning", solidHeader = TRUE, height = 350,
                  # USER INPUTS 2
                  numericInput("past2", label = ("Past Year"), value = 1987, min = 1950, max = 2015, step = 1),
                  numericInput("current2", label = ("Current Year"), value = 2014, min = 1950, max = 2015, step = 1),
                  numericInput("valuepast", label = ("Farmland Value from Past Year"), value = 2000)
              ),
              box(title = "Results", status = "success", solidHeader = TRUE, height = 350,
                  # CALCULATIONS 2
    ...
    tabItem(tabName = "download",
           fluidRow(
             box(
               title = "Choose State", status = "info", solidHeader = TRUE,
